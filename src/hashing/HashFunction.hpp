...
protected:
  ...
  uint64_t bijectiveMap(uint64_t a, uint64_t b) {
    // This will overflow but it's fine since wrap around should just be a
    // modulo See
    // https://stackoverflow.com/questions/18195715/why-is-unsigned-integer-overflow-defined-behavior
    // See
